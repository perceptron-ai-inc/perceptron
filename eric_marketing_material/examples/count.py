...
text_prompt = "Help me count the puppies. Point to each."
IMAGE_NAME = "count-puppies.jpg"
...
def count(frame_path: str):
    scene = image(frame_path)
    return scene + text("Help me count the puppies. Point to each.")

result = count(str(IMAGE_PATH))
